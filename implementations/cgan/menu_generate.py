...
optdataset = int(input("Choisissez le dataset à tester [0-%s]: " % cnt) or 0)
...
print("menu le dataset choisi est " + str(optdataset))
print("menu le mot choisi est " + optgenword) 
