...
def sample_label_id_image(n_row, batches_done,date_string):
    ...
    labels = Variable(LongTensor(labels))
    gen_imgs = generator(z, labels)
    save_image(gen_imgs.data[int(opt.genidlabel)],  "/content/gdrive/My Drive/TFE/images/"+date_string+"/gen_"+opt.genidlabel+"_%d.png" % batches_done, nrow=n_row, normalize=True)
