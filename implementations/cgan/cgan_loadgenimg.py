...
def sample_image(n_row, batches_done,date_string):
    ...
    save_image(gen_imgs.data,  "/content/gdrive/My Drive/TFE/dataset/"+str(opt.dataset)+"/"+str(date_string)+"/modelimage/full.png", nrow=n_row, normalize=True)
...
def sample_label_id_image(n_row, batches_done,date_string):
    ...
    if opt.gennumber > 0:
        ...
        save_image(numbre,  "/content/gdrive/My Drive/TFE/dataset/"+str(opt.dataset)+"/"+str(date_string)+"/modelimage/"+"gen_multiple_" + str(opt.gennumber) + ".png", nrow=n_row, normalize=True)
